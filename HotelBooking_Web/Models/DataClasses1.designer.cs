...
namespace HotelBooking_Web.Models
{
    ...
    partial void Deletetbl_TaiKhoan(tbl_TaiKhoan instance);
		...
		public System.Data.Linq.Table<tbl_GiaoDich> tbl_GiaoDich
		{
			get
			{
				return this.GetTable<tbl_GiaoDich>();
		...
		public System.Data.Linq.Table<vw_DanhSachDatPhong> vw_DanhSachDatPhong
		{
			get
			{
				return this.GetTable<vw_DanhSachDatPhong>();
		...
		public ISingleResult<sp_TimPhongResult> sp_TimPhongTrong(
